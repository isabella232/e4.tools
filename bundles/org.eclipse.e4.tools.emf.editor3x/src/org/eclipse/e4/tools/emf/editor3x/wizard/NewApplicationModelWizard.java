 ...
 * target container. The wizard creates one file with the extension "e4xmi". If
 * a sample multi-page editor (also available as a template) is registered for
 * the same extension, it will be able to open it.
 */

public class NewApplicationModelWizard extends Wizard implements INewWizard {
	 ...
	 */
	public NewApplicationModelWizard() {
		super();
	...
	public void addPages() {
		page = new NewModelFilePage(selection);
		addPage(page);
	}
