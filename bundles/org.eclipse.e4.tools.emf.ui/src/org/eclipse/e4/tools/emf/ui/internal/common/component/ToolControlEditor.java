...
public class ToolControlEditor extends AbstractComponentEditor {
	...
	public String getDescription(Object element) {
		return "ToolControl bla bla bla";
	}
	...
	public Image getImage(Object element, Display display) {
		if (image == null) {
			try {
				image = loadSharedImage(display, new URL("platform:/plugin/org.eclipse.e4.ui.model.workbench.edit/icons/full/obj16/ToolControl.gif"));
