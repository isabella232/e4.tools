...
public class VModelFragmentsEditor extends AbstractComponentEditor {
	...
	@Inject
	public VModelFragmentsEditor(EditingDomain editingDomain, ModelEditor editor, IResourcePool resourcePool) {
	...
	private Composite createForm(Composite parent, EMFDataBindingContext context, WritableValue master) {
...

		{
			...
			l.setText(Messages.VModelFragmentsEditor_Fragments);
